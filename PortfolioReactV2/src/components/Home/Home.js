        ...
        <div className={`${styles.topHome}`}>
          ...
          <div className={`${styles.rightHome}`}>
            <div className={`${styles.containerRectHome}`}>
              ...
              <div className={`${styles.svgCircleContainer}`}>
                <svg viewBox="0 0 1000 1000" className={`${styles.svgCircle}`}>
                ...
                <Link
                  ...
                  smooth
                  spy
                  style={{ position: 'inherit', width: '40px', height: '40px', zIndex: 13 }}
                >
                  <svg className={`${styles.svgArrowCircle} MouseHoverEffect`} viewBox="0 0 1000 1000">
